...
![Клонирование репозитория](image/04.png){#fig:004 width=70%}
...
![Создание необходимых каталогов](image/06.png){#fig:006 width=70%}


5. Отправка файлов. (рис. 4.7)

![Отправка файлов](image/07.png){#fig:007 width=70%}
